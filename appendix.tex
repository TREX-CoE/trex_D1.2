...
Moreover, you must also include the \mintinline{C}{vfc_probes.h} header at the beginning of \mintinline{C}{main.c}. You could add the following include statement after line 3:
...
binary tree, and to compute the \mintinline{C}{x[i] * y[i]} when the arrays are
...
... and optionally a \mintinline{C}{printf} statement:
