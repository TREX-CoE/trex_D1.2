...
\acro{QMCkl}{Quantum Monte Carlo kernel library}
...
\acro{SAV}{Slovak Academy of Sciences}
\acro{TREX}{Targeting REal chemical accuracy at the eXascale}
\acro{TREXIO}{TREX Input/Output}
