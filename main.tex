...
\newcommand{\DelTitle}{Report on pre-release of open-source human-readable implementation of QMCkl}

% Due date
\newcommand{\DueDate}{M13 -- 31-10-2021}

% Actual submission date
\newcommand{\SubDate}{18-10-2021}

% Main author (Leader)
\newcommand{\LeadAuthor}{Anthony Scemama (\ac{CNRS})}

% Contributing authors
\newcommand{\Contributors}{Vijay Gopal Chilkuri (\ac{CNRS}), Aurélien Delval (\ac{UVSQ}), Pablo Oliveira (\ac{UVSQ})}

% Reviewers
\newcommand{\Reviewers}{Fabio Affinito (\ac{CINECA}), Ivan Štich (\ac{SAV})}
